...
const handleClick = async () => {
   ...
   try {
    const deletejson = await axios.delete(`${process.env.REACT_APP_API_URL}/api/rumors/` + rumor._id)
...
const likeHandler = () => {
  ...
  try {
    axios.put(`${process.env.REACT_APP_API_URL}/api/rumors/` + rumor._id + "/like", { theId: user._id });
  } catch (err) {}
